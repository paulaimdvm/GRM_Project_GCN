...
def sweep_depth(
    ...
    **kwargs,
    ...
    for n_layers in layer_counts:
        ...
        print(
            f"  layers={n_layers:<3d}  |  train={tr:.4f}  val={va:.4f}  test={te:.4f}"
        )
...
def sweep_k_hops(
    ...
    results = []
    print("Sweep: K-hop Neighbourhood Order")
    print("-" * 60)
    ...
    for k_hops in k_values:
        ...
        results.append((k_hops, train_acc, val_acc, test_acc))
        print(
            f"  K={k_hops:<2d}  |  train={train_acc:.4f}  "
